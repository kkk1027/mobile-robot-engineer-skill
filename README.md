...
SSH 连接不是 G3/G4 授权。禁止绕过急停、安全控制器、制动、watchdog、权限与硬件保护；禁止使用 `StrictHostKeyChecking=no`，禁止读取或打印私钥、密码、Token。交给实机操作智能体前，请先阅读 [实机交接文档](docs/AGENT_HANDOFF_REAL_ROBOT.md)。
